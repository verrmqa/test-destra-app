...
const propsObj = {
  ...
  "filter": {
    ...
    const renderFilter = () => {
        ...
        return <Filter type='instruction' values={values} filter={filter} />;
      }

    const renderStages = () => {
        const { filter, lockCounter, promoLock, block } = propsObj;
        const { user } = propsObj;
